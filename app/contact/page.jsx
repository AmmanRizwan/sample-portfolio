      ...
      <div className='container mx-auto'>
        <div className='flex flex-col xl:flex-row gap-[30px]'>
          <div className='xl:w-[54%] order-2 xl:order-none'>
            <form className='flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl'><h3 className='text-4xl text-accent'>Let&apos;s work together</h3>
            ...
            <Select>
              ...
              <SelectContent>
                <SelectGroup>
                  <SelectLabel>Selet a service</SelectLabel>
              ...
              {info.map((item, index)=> {
                return (
                  <li key={index} className='flex items-center gap-6'>
                      <div className='w-[52px] h-[52px] xl:w-[74px] xl:h-[72px] bg-[#27272c] text-accent rounded-md flex items-center justify-center'>
